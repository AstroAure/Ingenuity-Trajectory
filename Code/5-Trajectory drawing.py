...
#Initialisation
images_filename = '0-Images\\Flight 6\\'
...
POSITIONS_X = np.array(POSITIONS)[:,0]
POSITIONS_Y = -np.array(POSITIONS)[:,1]
...
plt.plot(POSITIONS_X, POSITIONS_Y, marker = 'x', markersize = 6, markeredgewidth = 2, linewidth = 3, color='white')
plt.axis('equal')

plt.savefig("5-Trajectories\\" + images_filename[9:-1] + ".png")
